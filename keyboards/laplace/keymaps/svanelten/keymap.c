...
{
  MC_GREETS = SAFE_RANGE, // email greeting
  MC_GSTAT,               // git status
  MC_GBRA,                // git branch
  MC_GADD,                // git add .
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_PROG] = LAYOUT(
    DE_RING,  MC_GLOG,  MC_GPUL,  MC_GPSH,  MC_GREM,  _______,  DE_LESS,  DE_MORE,  DE_LBRC,  DE_RBRC,  DE_QST,   _______,  _______,
    _______,  MC_GADD,  MC_GSTAT, _______,  _______,  _______,  _______,  DE_LCBR,  DE_RCBR,  DE_LPRN,  DE_RPRN,  _______,
    _______,  DE_PIPE,  MC_GRST,  MC_GCOM,  _______,  MC_GBRA,  _______,  DE_DQOT,  DE_QUOT,  DE_GRV,   DE_TILD,  _______,
    _______,  _______,  _______,  _______,  _______,            _______,            _______,  _______,  _______,  _______
  )
};
  ...
  switch (keycode)
  {
    case MC_GREETS:
      if (record->event.pressed)
      {
        ...
        SEND_STRING("Gr" SS_TAP(X_LBRACKET) SS_TAP(X_MINUS) "e," SS_TAP(X_ENTER) "sve");
        return true;
      }
      else
      {
