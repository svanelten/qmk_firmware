...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = KEYMAP(
    ...
    KC_LCTL,    KC_LGUI,    KC_LALT,                            KC_SPC,                                                     KC_RALT,    MO(_FL),    KC_NO,      MO(_NL),    KC_RCTL),
  ...
  [_FL] = KEYMAP(
    ...
    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_END,     KC_LEFT,    KC_DOWN,    KC_RIGHT,   KC_TRNS,    KC_TRNS,    KC_NO,    \
    KC_TRNS,    KC_TRNS,    KC_TRNS,                            KC_TRNS,                                                    KC_DEL,     KC_TRNS,     KC_NO,      KC_TRNS,    KC_INS),
